...
## 블록 팩 (교과는 힌트일 뿐 — **어느 교과에서도 사용 가능**)

아래 패턴은 특정 교과에서 흔히 쓰일 뿐 그 교과 **전용이 아니다**. **블록은 교과가 아니라 활동(학생에게 무엇을 시킬지)에 맞춰 고른다** — 예: 연표(timeline)는 과학사·문학 플롯에도, 비교표는 전 교과에, 변인표는 어떤 탐구 활동에도 쓸 수 있다. 아래 대괄호 교과 표기는 "흔한 맥락" 힌트다(엔진에 교과-블록 하드 잠금 없음).
