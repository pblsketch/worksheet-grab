...
> `bd640be`(마이그레이션/렌더 회귀 2건 교정 — 무드 밖) · P2-c-3 `3a2545b`(표 밀도) · P2-c-4 `d784034`
> (섹션헤딩·지시문 모티프) · P2-c-5 `c089d06`(팩 확장 → 5무드 서랍: calm/exam/wide/angular/soft) ·
> P2-c-6 `fabbb47`(callout 헤더 모티프·의미색 보존) · P2-c-7 `2f2eb17`(강한 색 표 헤더 톤).
> **무드 축: 5무드 × 레이아웃 변형(헤더·표밀도·섹션헤딩/지시문·callout·표헤더) 일관 디자인 언어 — 커버리지 충분.**
