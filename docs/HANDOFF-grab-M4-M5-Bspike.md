...
> **[2026-07-31 상태] M4·M5 완료 → main 병합·푸시(main `50876d4`). B′ 만 남음.**
> B′ 는 이 문서 §3 요약 대신 **`docs/HANDOFF-grab-Bspike.md`** 를 SSOT 로 쓴다(codex 리뷰 #5~#7 의
> 정확한 거부/허용 매트릭스 반영). 아래 §3 M4/M5 절은 완료 기록으로만 남긴다.
>
